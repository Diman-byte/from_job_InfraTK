...
namespace ReportGenerator.Services
{
    public class DataServerClient
    {
        ...
        public DataServerClient(string DataServerAddress, string DataServerPort)
        {
            // раньше брали настройки с файла
            //ConfigService configService = new ConfigService();
            //configService.LoadSettings();
            _baseUrl = $"http://{DataServerAddress}:{DataServerPort}/api";
        }
